...
{ 
  ...
  /* YOUR MODIFIERS HERE */ class MyIterator implements Iterator<T> 
  {
	...
	//A: Checks to make sure that we aren't trying to remove nothing
	if ( ! _okToRemove )
	...
	// A: Removing the first, last, or in between
	//      
	//if ________...
	else {
